...
public class developerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressBar=(ProgressBar)findViewById(R.id.Progressdev7);
        mywebview=findViewById(R.id.webview7);
        ...
        mywebview.loadUrl("https://cseb-iter.netlify.app/web/developers.html/");
        //connection manager
