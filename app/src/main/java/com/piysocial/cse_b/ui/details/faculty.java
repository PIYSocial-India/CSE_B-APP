...
public class faculty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressBar=(ProgressBar)findViewById(R.id.Progressdev36);
        mywebview=findViewById(R.id.webview21);
        ...
        mywebview.loadUrl("https://cseb-iter.netlify.app/web/teachers.html/");
        //connection manager
