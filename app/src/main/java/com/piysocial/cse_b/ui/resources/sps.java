...
public class sps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressBar=(android.widget.ProgressBar)findViewById(R.id.Progressdev87);
        mywebview=findViewById(R.id.webview87);
        ...
        mywebview.loadUrl("https://cseb-iter.netlify.app/web/resources/solution/ps.html/");
        //connection manager
