...
public class ttwednesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressBar = (android.widget.ProgressBar) findViewById(R.id.Progressdev39);
        mywebview = findViewById(R.id.webview39);
        ...
        mywebview.loadUrl("https://cseb-iter.netlify.app/web/timetable/ttwednesday.html/");
        //connection manager
