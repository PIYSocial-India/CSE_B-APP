...
public class sala extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressBar=(android.widget.ProgressBar)findViewById(R.id.Progressdev88);
        mywebview=findViewById(R.id.webview88);
        ...
        mywebview.loadUrl("https://cseb-iter.netlify.app/web/resources/solution/ala.html/");
        //connection manager
